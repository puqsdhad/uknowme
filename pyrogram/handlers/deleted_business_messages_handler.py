...
class DeletedBusinessMessagesHandler(Handler):
    """The deleted business messages handler class. Used to handle deleted messages from a connected business account.
    ...
    Parameters:
        callback (``Callable``):
            Pass a function that will be called when one or more business messages have been deleted.
            It takes *(client, messages)* as positional arguments.

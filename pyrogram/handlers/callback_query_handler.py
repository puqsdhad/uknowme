...
class CallbackQueryHandler(Handler):
    ...
    def compose_data_identifier(query: CallbackQuery) -> Identifier:
        ...
        Parameters:
            query (:obj:`~pyrogram.types.CallbackQuery`):
                The CallbackQuery object to compose of.

        Returns:
            :obj:`~pyrogram.types.Identifier`: An Identifier object.
        """
    ...
    async def check(self, client: pyrogram.Client, query: CallbackQuery) -> bool:
        """

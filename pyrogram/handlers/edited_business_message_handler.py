...
class EditedBusinessMessageHandler(Handler):
    """The EditedBusinessMessage handler class. Used to handle edited messages from a connected business account.
    ...
    Parameters:
        callback (``Callable``):
            Pass a function that will be called when a new edited business message arrives.
            It takes *(client, message)* as positional arguments.
